...
<head><title>修改部门</title></head>
		...
		<form:form commandName="department" class="layui-form" action="${pageContext.request.contextPath}/admin/UpdateDepartmentOver.do" method="post">
            <div class="layui-form-item">
                <label class="layui-form-label">部门名称：</label>
                <div class="layui-input-inline">
               		<form:hidden path="dept_id" id="dept_id" />

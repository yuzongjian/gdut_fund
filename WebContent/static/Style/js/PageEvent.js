...
//	$("html").css("overflow-x","hidden");
    ...
    var paras1=$(".FirstMenu");
    var paras2=$(".SecondMenu");
...
function changClass(){
		var valFile = document.getElementsByName("valFile")[0].value;
		valFile =$.trim(valFile); //去空格
		if(!valFile){
			var div =  document.getElementsByName("valFile")[0];
			div.setAttribute("class", "tet"); 
		}else{
			var div =  document.getElementsByName("valFile")[0];

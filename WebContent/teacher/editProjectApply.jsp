...
<title>修改国家基金申请工作跟踪表</title></head>
<body>
<div class="OpenNormal">
	<form:form  commandName="Item_track" id="inputForm" action="${pageContext.request.contextPath}/teacher/Updata.do" method="post" class="form-horizontal">		
			<div class="top"></div>
		...
		<tr>
		<td ><input name="old_title"  value=${item_track.old_title}  /></td>
		...
		<td><input name="time" id="appalyDate1" value=${item_track.time} onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="true" reg="^.+$" /></td>
		<td><input  name="content" type=textarea style="height:70px" id="content1" value=${item_track.content} /></td>
		<td><input id="sign1" name="sign" value=${item_track.sign} /></td>
		<td></td>
		</c:forEach>

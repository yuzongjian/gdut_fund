...
<head><title>修改信息</title></head>
		...
		<form:form  commandName="User" class="layui-form" action="${pageContext.request.contextPath}/teacherUpdate.do" method="post">
            <div class="layui-form-item">
                <label class="layui-form-label">姓名；</label>
                <div class="layui-input-inline">
                    <form:input path="name"  placeholder="姓名" class="layui-input" lay-verify="required" maxlength="30"/>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input path="account"  placeholder="请输入职工号" class="layui-input" autocomplete="off" lay-verify="required"/>
                </div>
                <div class="layui-form-mid layui-word-aux star">必填</div>
            </div>
             <div class="layui-form-item">
       ...
       <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input path="email"  class="layui-input" maxlength="30"/>
                </div>            
            </div>

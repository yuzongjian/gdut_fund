...
<head><title>添加申报项目</title></head>
		<div class="layui-body" id="content_body">
			...
			<span class="layui-breadcrumb head-breadcrumb">
				...
				<a><cite>添加申报项目</cite></a>
			</span>
			<!-- 内容主体区域 -->
			 <div class="layui-tab-content">
        <fieldset class="layui-elem-field layui-field-title">
            <legend>添加申报项目</legend>
        </fieldset>
		<form:form class="layui-form" action="${pageContext.request.contextPath}/teacher/CreateProjectOver.do" commandName="project" method="post">
            <div class="layui-form-item">
                <label class="layui-form-label">项目名称：</label>
                <div class="layui-input-inline">
                    <form:input  path="name" value="" placeholder="项目名称" class="layui-input" lay-verify="required" maxlength="30"/>
                </div>
   ...
   <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                          <form:select id="type" path="type" lay-filter="districtFilter">
					            <form:option value="" >项目类型选择</form:option>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <form:select id="department" path="department"  lay-filter="districtFilter">          
                        	<form:option value="">请选择您的学院</form:option>    

...
<head><title>修改申报项目</title></head>
		...
		<form:form class="layui-form" action="${pageContext.request.contextPath}/teacher/EditProject.do" method="post" commandName="project">
			<form:hidden path="id" id="id"/>
            <div class="layui-form-item">
                <label class="layui-form-label">项目名称：</label>
                <div class="layui-input-inline">
                    <form:input id="name" path="name" placeholder="项目名称" class="layui-input" lay-verify="required" maxlength="30"/>
                </div>
   ...
   <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input id="applicant" path="applicant" value="" placeholder="请输入申请人" class="layui-input" autocomplete="off" lay-verify="required"/>
                </div>
                <div class="layui-form-mid layui-word-aux star">必填</div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input  id="science_code" path="science_code"  placeholder="请输入科学部编码" class="layui-input" maxlength="30"/>
                </div>
                <div class="layui-form-mid layui-word-aux star">必填</div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input path="apply_code" id="apply_code" placeholder="请输入申请代码" class="layui-input" maxlength="30"/>
                </div>
                <div class="layui-form-mid layui-word-aux star">必填</div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <form:input id="version" path="version"  placeholder="请输入版本号" class="layui-input" maxlength="30"/>
                </div>
                <div class="layui-form-mid layui-word-aux star">必填</div>
            </div>
